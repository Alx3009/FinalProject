              ...
              <div class="row">
                <div class="col-md-7 pe-0">
                  <div class="form-left h-100 py-5 px-5">
                    <form
                      action="<?= base_url('authentication/create') ?>"
                      method="post"
                      class="row g-4"
                      autocomplete="off"
                    >
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group">
                          ...
                          <small class="text-danger"
                            ><?= isset($validation) ? display_error($validation, 'name') : '' ?></small
                          >
                        </div>
                      </div>
                      ...
                      <div class="col-12 mt-2">
                        ...
                        <div class="input-group">
                          ...
                          />
                          <small class="text-danger"
                            ><?= isset($validation) ? display_error($validation, 'cpassword') : '' ?></small
                          >
                        </div>
                      </div>
                      ...
                      <input
                        ...
                        name="second_intern"
                        placeholder=""
                        value="<?= set_value('second_intern') ?>"
                      />
                      <div class="col-sm-6 mt-3">
                        <a
                          href="<?= site_url('authentication/signin') ?>"
                ...
                <div class="my-auto mx-4">
                  ...
                  <div class="img">
                    <img
                      src="<?php echo base_url() ?>images/presidentlogo.png"
                    />
                  </div>

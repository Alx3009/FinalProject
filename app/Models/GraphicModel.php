...
class GraphicModel extends Model
{
    ...
    {   
        ...
        $suhu = mysqli_query($konek, "SELECT temp FROM chart_sensor WHERE ID>='$id_awal' AND ID<='$id_akhir' ORDER BY ID ASC");
    ...
    {   
        ...
        $tanggal = mysqli_query($konek, "SELECT date FROM chart_sensor WHERE ID>='$id_awal' AND ID<='$id_akhir' ORDER BY ID ASC");
        $tds = mysqli_query($konek, "SELECT tds FROM chart_sensor WHERE ID>='$id_awal' AND ID<='$id_akhir' ORDER BY ID ASC");
